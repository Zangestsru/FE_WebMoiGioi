...
/**
 * ForgotPasswordModal - Synchronized with Login/Register modal design.
 * Features a left image panel and right form panel.
 */
export function ForgotPasswordModal({ onBackToLogin, onSuccess }: ForgotPasswordModalProps) {
  ...
  return (
    <div className="flex w-full flex-col sm:flex-row bg-white overflow-hidden">
      ...
      <div
        className="relative w-full sm:w-[440px] shrink-0 bg-cover bg-center bg-no-repeat rounded-t-xl sm:rounded-none sm:rounded-l-xl overflow-hidden bg-[#0a1632] flex items-end p-6 h-[160px] sm:h-auto hidden sm:flex"
        style={{
